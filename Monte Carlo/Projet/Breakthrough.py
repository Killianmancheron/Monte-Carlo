...
class Board():
    ...
    def play (self, move):
        ...
        if col != Empty:
            self.h = self.h ^ self.hashTable [col] [move.x2] [move.y2]
        self.h = self.h ^ self.hashTable [move.color] [move.x2] [move.y2]
        self.h = self.h ^ self.hashTable [move.color] [move.x1] [move.y1]
